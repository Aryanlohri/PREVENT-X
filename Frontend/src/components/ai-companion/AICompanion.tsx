...
import { sendChatMessage } from "@/lib/queries";
...
const quickChips = ["What is normal BP?", "I feel anxious", "Diet for high blood sugar", "How much should I exercise"];
...
export const AICompanion = () => {
  ...
  const mutation = useMutation({
    ...
    onError: () => {
      setTyping(false);
      setMessages((prev) => [...prev, { role: "assistant", content: "I'm having a little trouble connecting to my servers right now." }]);
    }
  });
          ...
          >
            ...
            <div className="gradient-primary p-4 flex items-center justify-between flex-shrink-0">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-heading font-semibold text-primary-foreground text-sm">PreventX Medical NLP</h4>
                  <p className="text-xs text-primary-foreground/70">Secure Local AI • Here to support you</p>
                </div>
              </div>
