...
def predict_health_risk(
    ...
    """Predicts health risk based on input vitals."""
    # Build input array
    X_input = np.array([[age, bmi, sys_bp, dia_bp, hr, sugar, activity]])
    ...
    # Calculate an overall risk score out of 100 based on probabilities
    # High risk probability weighted most heavily
